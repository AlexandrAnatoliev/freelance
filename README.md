<div align="center">
  ...
  ![Version 1.0.3](https://img.shields.io/badge/Version-1.0.3-orange.svg)
...
* Простая файловая «админка» через редактирование массивов в calc.php

#### 4. Счёт на оплату

* Бланк строгой формы (как в 1С), чёткие рамки
* Нумерация: Счёт № 123456-987654 от ДД.ММ.ГГГГ
...
* Комментарии в коде
* Лёгкая смена товаров и цен через конфигурационные массивы
* Скриншоты работы в репозитории

#### 6. Технический долг / Баги

* Корректное отображение рамок и стилей в PDF
* Корректное сохранение PDF из письма на мобильных
* Тестирование на реальном хостинге Hostia
...
```
 zip -r releases/v_1_0_3.zip .htaccess captcha.php checkout.php composer.json composer.lock configs/ generatePDF.php img/ calc.php invoice.php mailer.php README.md styles/ utils/ vendor/
```
